...
def gui():
	req = u"Fluffy@Fluffy_Brick$ Привет. Я УПК(Умный Пушистый Кирпич). Беда в том, что я понимаю не любые формы запросов... \n Скажи <ФРАЗУ СЮДА ДОБАВЬ>, и я начну тебя слушать. Если хочешь спросить о чём-то, скажи 'вопрос'. Можешь так же спросить меня: 'погода в городе москва', например. Еще я могу перевести фразу на английский или русский язык: 'переведи на английский',- например, - 'язык...'\n Чтобы закрыть меня, нажми 'Q'\n <аза-за-за-за. Ты только что попробовал нажать Q> }:) Ctrl+C рулит."
	palette = [
		('banner', '', '', '', '#fff', '#11e'),
		('streak', '', '', '', 'g50', '#11e'),
		('inside', '', '', '', 'g38', '#229'),
