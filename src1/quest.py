...
#################################################################################
def Trans(text, lang):
	langs = {'русский':'ru','английский':'en','немецкий':'de','испанский':'es','французский':'fr','китайский':'zh','греческий':'el','иврит':'he','тайский':'th','эстонский':'et','японский':'ja','грузинский':'ka'}
	try:
